        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
			...
			<div class="col-md-12 col-sm-12  ">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Ülke Karbon Değerleri Listesi<small>Veriler anlık olarak güncellenmektedir. </small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
              ...
              <td><?php echo $ulkekitasi; ?></td>
						  ...
						  <td style="<?php echo $tableStyle; ?>">
							<a href='adminGüncelle.php?ulkeID=<?php echo $ulkeID; ?>&user_id=<?php echo $userID; ?>' style='width:100px; font-size:12px;background-color:green' class='btn btn-primary btn-xs'><i class='fa fa-refresh'></i> Düzenle </a>
